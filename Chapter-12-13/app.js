...
//          console.log("First Value "+userInput1+" is Largest Number");
//      }
//     else{
//         console.log("Second Value "+userInput2+" is Largest Number");
// }
...
// if(userInput>0){
    ...
    //  let userInput=prompt("Enter a character to check vowel or not").toLowerCase();
...
// let time = prompt("Input 24 hours clock format");
